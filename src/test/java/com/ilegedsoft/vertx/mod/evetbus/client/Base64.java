...
-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9,-9         // Decimal 244 - 255 */
   ...
   *
   * @param msg A zMessage to include with usage info.
   */
   ...
   * @return The Base64-encoded object
   * @see org.vertx.java.core.json.impl.Base64#GZIP
   * @see org.vertx.java.core.json.impl.Base64#DONT_BREAK_LINES
   * @since 2.0
   */
  ...
  public static byte[] decodeFromFile(final String filename) {
    ...
    try {
      ...
      // Open a stream
      bis = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), DECODE);
  ...
  public static boolean encodeFileToFile(final String infile, final String outfile) {
    ...
    try {
      in = new InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(infile)),
          ENCODE);
   ...
   *
   * @see org.vertx.java.core.json.impl.Base64
   * @since 1.3
   */
  public static class InputStream extends java.io.FilterInputStream {
     ...
     * @param in      the <tt>java.io.InputStream</tt> from which to read data.
     * @param options Specified options
     * @see org.vertx.java.core.json.impl.Base64#ENCODE
     * @see org.vertx.java.core.json.impl.Base64#DECODE
     * @see org.vertx.java.core.json.impl.Base64#DONT_BREAK_LINES
     * @since 2.0
     */
